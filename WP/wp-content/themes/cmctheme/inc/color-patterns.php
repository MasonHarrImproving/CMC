<?php
/**
 * Columbus Metro Club: Color Patterns
 *
 * @package WordPress
 * @subpackage cmctheme
 * @since 1.0
 ...
 */
function cmctheme_custom_colors_css() {
	...
	/**
	 * Filter Columbus Metro Club default saturation level.
	 *
	 * @since Columbus Metro Club 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'cmctheme_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Columbus Metro Club default selection saturation level.
	 *
	 * @since Columbus Metro Club 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'cmctheme_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter Columbus Metro Club default lightness level.
	 *
	 * @since Columbus Metro Club 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'cmctheme_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Columbus Metro Club default hover lightness level.
	 *
	 * @since Columbus Metro Club 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'cmctheme_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Columbus Metro Club default selection lightness level.
	 *
	 * @since Columbus Metro Club 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'cmctheme_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters Columbus Metro Club custom colors CSS.
	 *
	 * @since Columbus Metro Club 1.0
	 *
	 ...
	 */
	return apply_filters( 'cmctheme_custom_colors_css', $theme_css, $primary_color, $saturation );
}
